...
export default function picanha() {
  ...
  const handleCompra = () => {
    ...
    adicionarProduto(
      require('../../../Images/picanha.png'),
      'Picanha de novilho Angus',
      7.99
    );
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titulo}>picanha</Text>
      <View style={{ alignItems: 'center' }}>
        <Image source={require('../../../Images/picanha.png')} style={styles.img} />
      </View>
      <View>
        <Text style={styles.descricao}>Picanha de novilho Angus</Text>
