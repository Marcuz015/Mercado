...
export default function presunto() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titulo}>Presunto</Text>
      <View style={{ alignItems: 'center' }}>
        <Image source={require('../../../Images/presunto.png')} style={styles.img} />
      </View>
      <View>
        <Text style={styles.descricao}>Presunto cozido Sadia</Text>
