...
export default function mortadela() {
  ...
  const handleCompra = () => {
    ...
    adicionarProduto(
      require('../../../Images/Mortadela.png'),
      'Mortadela Toucinho Seara',
      7.99
    );
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titulo}>Mortadela</Text>
      <View style={{ alignItems: 'center' }}>
        <Image source={require('../../../Images/Mortadela.png')} style={styles.img} />
      </View>
      <View>
        <Text style={styles.descricao}>Mortadela Toucinho Seara</Text>
