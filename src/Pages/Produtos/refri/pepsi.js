...
export default function pepsi() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titulo}>Pepsi 2 Litros</Text>
      <View style={{ alignItems: 'center' }}>
        <Image source={require('../../../Images/pepsi.png')} style={styles.img} />
      </View>
      <View>
        <Text style={styles.descricao}>Refrigerante Pepsi 2 Litros</Text>
        <Text style={{ fontSize: 40, textAlign: 'center', marginBottom: 20 }}>R$6,50</Text>
      </View>
      <View style={{ alignItems: 'center' }}>
