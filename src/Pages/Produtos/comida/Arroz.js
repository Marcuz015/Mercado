...
export default function Arroz() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titulo}>Arroz</Text>
      <View style={{ alignItems: 'center' }}>
        <Image source={require('../../../Images/Arroz.png')} style={styles.img} />
      </View>
      <View>
        <Text style={styles.descricao}>Arroz Tio João</Text>
        <Text style={{ fontSize: 40, textAlign: 'center', marginBottom: 20 }}>R$7,50</Text>
      </View>
      <View style={{ alignItems: 'center' }}>
