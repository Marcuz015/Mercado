...
export default function macarrao() {
  ...
  const handleCompra = () => {
    ...
    adicionarProduto(
      require('../../../Images/Macarrao.png'),
      'Macarrao Santa Amália',
      7.99
    );
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titulo}>Macarrao</Text>
      <View style={{ alignItems: 'center' }}>
        <Image source={require('../../../Images/Macarrao.png')} style={styles.img} />
      </View>
      <View>
        <Text style={styles.descricao}>Macarrao Santa Amália</Text>
